...
<header class="sticky">
    ...
    <div class="logo">
        <img id="logo" src="images/Logo.png" alt="jg_logo" />
    </div>
    <nav>
...
<main>
    <div class="case-study">
        ...
        <ul>
            <li><strong>InspirationResearch and Concept Development:</strong> <?php echo htmlspecialchars($inspiration); ?></li>
            <li><strong>3D Modeling:</strong> <?php echo htmlspecialchars($colorPalette); ?></li>
            <li><strong>Rendering:</strong> <?php echo htmlspecialchars($typography); ?></li>

            <li><strong>Review and Finalization:</strong> <?php echo htmlspecialchars($imagery); ?></li>
    ...
    <footer class="unique-footer-container">
        <div class="footer-top-section">
            ...
            <a href="https://www.instagram.com/gregory_joyal?igsh=MTF1OHBmMXk2bGh1Mg==" target="_blank">
              <img src="images/Icon akar-instagram-fill.svg" alt="Instagram" class="social-icon" /></a>
            <a href="https://www.facebook.com/share/152rp5uEYY/" target="_blank">
              <img src="images/Icon akar-facebook-fill.svg" alt="Facebook" class="social-icon" /></a>
            ...
            <div class="footer-logo">
                <img src="images/Logo.png" alt="Logo" class="footer-logo-image" />
            </div>
        </div>
